...
//    public void addImage(List<CardsImages> cards) {
//        synchronized (this) {
//            if (!this.primaryCardList.contains(cards)) {
//                List<CardsImages> temp = new ArrayList<>();
//                for (Card cardImg : cardList) {
//                    if(cardImg.getImg().equals(cards))
//                    temp.add(cardImg);
//                }
//                this.primaryCardList.addAll(temp);
//            }
//            this.primaryCardList.addAll(cards);
//        }
//    }
...
//    public List<Card> readCardList(String... params) {
//
//        HttpURLConnection connection = null;
//        BufferedReader reader = null;
//
