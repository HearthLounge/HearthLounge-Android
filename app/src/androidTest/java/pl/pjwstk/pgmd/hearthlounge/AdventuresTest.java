...
public class AdventuresTest {
    ...
    public void adventuresTest() {
        ...
        onView(allOf(isAssignableFrom(TextView.class),
                ...
                .check(matches(withText("Adventures")));

        onView(withId(R.id.adventures_scrollView)).perform(swipeUp());

        ViewInteraction linearLayout = onView(
                allOf(withId(R.id.one_night_in_karazhan), isDisplayed()));
        ...
        onView(allOf(isAssignableFrom(TextView.class),
                withParent(isAssignableFrom(Toolbar.class))))
                .check(matches(withText("One Night in Karazhan")));

        ViewInteraction imageView = onView(
                allOf(withId(R.id.icon_adventures),
                        childAtPosition(
...
//        imageView4.check(matches(isDisplayed()));
        ...
        int count = CardListCache.getInstance().getCardList("One Night in Karazhan").size();
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.text_view_count_cards), withText("8 results"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        0),
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("8 results")));
